...
ServerConnection::ServerConnection(int _connectionId, std::shared_ptr<Address> _address, std::shared_ptr<UdpListener> _listener)
    : Connection(_connectionId, _address), listener(_listener) {}
