...
ClientConnection::ClientConnection(std::shared_ptr<Address> _address, std::shared_ptr<UdpClient> _client)
    : Connection(0, _address), client(_client) {}

void ClientConnection::connect() { sendHandshake(); }
